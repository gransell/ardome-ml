...
class AMLEnvironment( openbuild.env.Environment ):
	...
	def install_packages( self ):
		...
		elif self[ 'target' ] == 'lsb_4_0_32':
			if os.path.exists( 'bcomp/boost' ):
				self.install_config( 'config/lsb_4_0_32/boost.pc', 'bcomp/boost' )
				self.install_config( 'config/lsb_4_0_32/boost_date_time.pc', 'bcomp/boost' )
				self.install_config( 'config/lsb_4_0_32/boost_filesystem.pc', 'bcomp/boost' )
				self.install_config( 'config/lsb_4_0_32/boost_python.pc', 'bcomp/boost' )
				self.install_config( 'config/lsb_4_0_32/boost_regex.pc', 'bcomp/boost' )
				self.install_config( 'config/lsb_4_0_32/boost_signals.pc', 'bcomp/boost' )
				self.install_config( 'config/lsb_4_0_32/boost_system.pc', 'bcomp/boost' )
				self.install_config( 'config/lsb_4_0_32/boost_thread.pc', 'bcomp/boost' )
				self.install_config( 'config/lsb_4_0_32/boost_unit_test_framework.pc', 'bcomp/boost' )
			self.install_config( 'config/lsb_4_0_32/loki.pc', 'bcomp/loki-0.1.6' )
			self.install_config( 'config/lsb_4_0_32/xerces.pc', 'bcomp/xercesc' )
			self.install_config( 'config/lsb_4_0_32/ffmpeg.pc', 'bcomp/ffmpeg' )
			if os.path.exists( 'bcomp/sdl' ):
				self.install_config( 'config/lsb_4_0_32/sdl.pc', 'bcomp/sdl' )
		elif self[ 'target' ] == 'lsb_4_0_64':
			self.install_config( 'config/lsb_4_0_64/boost.pc', 'bcomp/boost' )
			self.install_config( 'config/lsb_4_0_64/boost_date_time.pc', 'bcomp/boost' )
			self.install_config( 'config/lsb_4_0_64/boost_filesystem.pc', 'bcomp/boost' )
			self.install_config( 'config/lsb_4_0_64/boost_python.pc', 'bcomp/boost' )
			self.install_config( 'config/lsb_4_0_64/boost_regex.pc', 'bcomp/boost' )
			self.install_config( 'config/lsb_4_0_64/boost_signals.pc', 'bcomp/boost' )
			self.install_config( 'config/lsb_4_0_64/boost_thread.pc', 'bcomp/boost' )
			self.install_config( 'config/lsb_4_0_64/boost_unit_test_framework.pc', 'bcomp/boost' )
			self.install_config( 'config/lsb_4_0_64/loki.pc', 'bcomp/loki-0.1.6' )
			self.install_config( 'config/lsb_4_0_64/xerces.pc', 'bcomp/xercesc' )
			self.install_config( 'config/lsb_4_0_64/libavcodec.pc', 'bcomp/ffmpeg' )
			self.install_config( 'config/lsb_4_0_64/libavdevice.pc', 'bcomp/ffmpeg' )
			self.install_config( 'config/lsb_4_0_64/libavformat.pc', 'bcomp/ffmpeg' )
			self.install_config( 'config/lsb_4_0_64/libavutil.pc', 'bcomp/ffmpeg' )
			self.install_config( 'config/lsb_4_0_64/sdl.pc', 'bcomp/sdl' )
