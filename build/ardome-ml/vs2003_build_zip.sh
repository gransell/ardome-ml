...
cp -r build/release/vs2003/bin/* TMPZIP/aml/bin/release/
cp -r build/release/vs2003/lib/* TMPZIP/aml/lib/release/
...
cp -r build/debug/vs2003/bin/* TMPZIP/aml/bin/debug/
cp -r build/debug/vs2003/lib/* TMPZIP/aml/lib/debug/
