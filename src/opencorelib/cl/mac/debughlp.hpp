...
#ifndef _AUBASE_MSW_DEBUGHLPH_H_
#define _AUBASE_MSW_DEBUGHLPH_H_

//
//#include "wx/msw/wrapwin.h"
//#ifndef __WXWINCE__

#include <au_base/dynlib.h>
//#include <au_base/msw/private.h>
#include <imagehlp.h>
...
// Always complile / Mats Lindelöf, 2007-01-03
// #if wxUSE_DBGHELP
...
public:
    ...
    static const Ardendo::t_string& GetErrorMessage();
    ...
    static Ardendo::t_string DumpSymbol(PSYMBOL_INFO pSymInfo, void *pVariable);

    // return the name of the symbol with given type index
    static Ardendo::t_string GetSymbolName(PSYMBOL_INFO pSymInfo);
...
private:
    ...
    static Ardendo::t_string DumpField(PSYMBOL_INFO pSymInfo,
                              void *pVariable,
                              unsigned level);

    static Ardendo::t_string DumpBaseType(BasicType bt, DWORD64 length, void *pVariable);

    static Ardendo::t_string DumpUDT(PSYMBOL_INFO pSymInfo,
                            void *pVariable,
                            unsigned level = 0);
};
...
#endif // _AUBASE_MSW_DEBUGHLPH_H_
