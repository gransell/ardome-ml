...
template < typename T >
ML_DECLSPEC boost::shared_ptr< T > channel_convert_template(const boost::shared_ptr< T > &input_audio, int channels)
{
...
ML_DECLSPEC audio::pcm8_ptr channel_converter( const audio::pcm8_ptr &input, int channels )
{
	return channel_convert_template< audio::pcm8 >( input, channels );
}

ML_DECLSPEC audio::pcm16_ptr channel_converter( const audio::pcm16_ptr &input, int channels )
{
	return channel_convert_template< audio::pcm16 >( input, channels );
}

ML_DECLSPEC audio::pcm24_ptr channel_converter( const audio::pcm24_ptr &input, int channels )
{
	return channel_convert_template< audio::pcm24 >( input, channels );
}

ML_DECLSPEC audio::pcm32_ptr channel_converter( const audio::pcm32_ptr &input, int channels )
{
	return channel_convert_template< audio::pcm32 >( input, channels );
}

ML_DECLSPEC audio::floats_ptr channel_converter( const audio::floats_ptr &input, int channels )
{
	return channel_convert_template< audio::floats >( input, channels );
}
