...
static indexer_job_ptr indexer_job_factory( const std::wstring &url, index_type::type file_type, boost::uint16_t v4_index_entry_type = 0 );
...
static indexer_job_ptr indexer_job_factory( const std::wstring &url, index_type::type file_type, boost::uint16_t v4_index_entry_type )
{
...
class indexer
{
	public:
		...
		indexer_item_ptr request( const std::wstring &url, index_type::type file_type, boost::uint16_t v4_index_entry_type = 0 )
		{
			boost::recursive_mutex::scoped_lock lock( mutex_ );
...
indexer_item_ptr ML_DECLSPEC indexer_request( const std::wstring &url, index_type::type file_type, boost::uint16_t v4_index_entry_type )
{
