...
class input_creator_handler;
typedef ML_DECLSPEC Loki::SingletonHolder< input_creator_handler, Loki::CreateUsingNew, Loki::DefaultLifetime,
                               Loki::ClassLevelLockable > the_input_creator_handler;
