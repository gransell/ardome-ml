...
void test_framecount_tc_conversion( frame_rate::type fps, bool drop_frame );
void test_tc_to_string();
void test_string_to_tc();
void test_media_time_division();
void test_tc_midnight_wrap_around( frame_rate::type fps, bool drop_frame );
...
void test_timecode()
{
	test_tc_to_string();
	test_string_to_tc();
	test_media_time_division();

	BOOST_FOREACH( const tc_test &test, TC_TESTS )
	{
		test_tc_midnight_wrap_around( test.fps, test.drop_frame );
	}

	BOOST_FOREACH( const tc_test &test, TC_TESTS )
	{
		test_framecount_tc_conversion( test.fps, test.drop_frame );
	}
}
